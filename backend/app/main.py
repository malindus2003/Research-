...
from .routers import sensors, vision, predictions, inventory, recommendations, demand, kitchen, waste
...
app = FastAPI(
    ...
    description="Integrated 4-Component System for Food Demand Prediction, Smart Waste Sorting, Multi-Modal Spoilage Detection, and Kitchen Efficiency.",
    version="2.0.0"
)
...
# Register All 4 Research Project Components
...
app.include_router(inventory.router)        # Component 3 (Maddumage M. S - Inventory)
